...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.45-721300bc/TDLibFramework.zip",
            checksum: "7272fec2b8572fe7473629db0d182ed50942626e7faeff8aa5fbbc15ff31bb09"
        ),
        .testTarget(
