...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.14-90c36b60/TDLibFramework.zip",
            checksum: "eba45483d9c96fef66c4ea12938295ed42fdefb5267893172de2845eb177407b"
        ),
        .testTarget(
