...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.29-39d82693/TDLibFramework.zip",
            checksum: "805af42ccbb1c036c2857706aeb3369528f10bb8ec2ef3c79e95ebc728f315bb"
        ),
        .testTarget(
