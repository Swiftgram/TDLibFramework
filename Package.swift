...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.13-c95598e5/TDLibFramework.zip",
            checksum: "24f8800fde815733a7ceece1493ad95d2e0d286e5071e78c55735416ef2d956a"
        ),
        .testTarget(
