...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.28-77b34797/TDLibFramework.zip",
            checksum: "c3cd0f3164d688496be98c492122dfde5c5c5601c2d3d70e4460b0bb02fe14b8"
        ),
        .testTarget(
