...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.29-44b548c3/TDLibFramework.zip",
            checksum: "3d6fb5aa5e8bda44e94ddf9fcde9cb64647337999fb3bbf2290aacb6dae1d313"
        ),
        .testTarget(
