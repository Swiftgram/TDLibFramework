...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.48-34c390f9/TDLibFramework.zip",
            checksum: "4bdcf4bb8587c9e8137b03b23531a12ec8f07f8b0f2841679b6e7aeed9ba1ef3"
        ),
        .testTarget(
