...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.63-8ff05a0e/TDLibFramework.zip",
            checksum: "cc00087253a6876528368a5d52b2d18ba800425cfeb10e985558a25da20aa15d"
        ),
        .testTarget(
