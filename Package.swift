...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.36-91aa6c9e/TDLibFramework.zip",
            checksum: "56a279e3af6fd60401c9740906760bac36561c2560dbf6945a72d08957e5078c"
        ),
        .testTarget(
