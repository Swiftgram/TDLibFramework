...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.48-b8b08b02/TDLibFramework.zip",
            checksum: "be489c80c76365a1ab1528e069f9b6b557920787872924e3ce961d4f5c1e7b68"
        ),
        .testTarget(
