...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.63-8921c22f/TDLibFramework.zip",
            checksum: "f09a28b5f83d069d2d56611119b0b76597c80ade79006548c70e64df0a7f7545"
        ),
        .testTarget(
