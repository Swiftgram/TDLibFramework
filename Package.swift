...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.58-889bdf06/TDLibFramework.zip",
            checksum: "b63f3d58c3f8f5a281211163859483bb0a5246b1168a279e4c862a1e387b5ec7"
        ),
        .testTarget(
