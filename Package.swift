...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.51-6d74326c/TDLibFramework.zip",
            checksum: "1e38cb2c7c11705766118c69fdcc806ffb025d4c1edff0ea486b4c0e11f345cb"
        ),
        .testTarget(
