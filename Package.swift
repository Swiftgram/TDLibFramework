...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.14-677219a2/TDLibFramework.zip",
            checksum: "338dfd2b52682eab2a04da4cf4421407fbc1dae24b29ebb7b6bcfbcd24e83b1b"
        ),
        .testTarget(
