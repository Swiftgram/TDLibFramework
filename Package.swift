...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.63-1677a0c7/TDLibFramework.zip",
            checksum: "64af69ad60bb79ee9d86fa475bb19903762557be6a058dee8c8ac633e0f2fa7d"
        ),
        .testTarget(
