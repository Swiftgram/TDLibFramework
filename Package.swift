...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.23-b4c07559/TDLibFramework.zip",
            checksum: "fb0317d4c33f9b29c8096cf2d1f4309bf9969ce8bbb1c309df54c2ee86320f95"
        ),
        .testTarget(
