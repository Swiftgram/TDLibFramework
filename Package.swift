...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.44-28c6f2e9/TDLibFramework.zip",
            checksum: "ae5cb367bf2468a43e9d8d06b9995fab7d455eddf4cad7b5597da921c8e83032"
        ),
        .testTarget(
