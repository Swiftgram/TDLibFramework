...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.29-4e0c0009/TDLibFramework.zip",
            checksum: "ec134f38f7e8b534d22b2427be87288238e9114ca971cf0951107c27851be6ea"
        ),
        .testTarget(
