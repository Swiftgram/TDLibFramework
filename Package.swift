...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.38-d321984b/TDLibFramework.zip",
            checksum: "f6a844e2b7b52720e00e3666fb34b59a79e2799a82aac7c88a6cd1b90383c694"
        ),
        .testTarget(
