...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.41-eb98bbe6/TDLibFramework.zip",
            checksum: "4b5bfd3d1c177bfb400228e87f91c4c5b2e4281ac5cbd7ee4d0ccbc589f5eac3"
        ),
        .testTarget(
