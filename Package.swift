...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.46-b498497b/TDLibFramework.zip",
            checksum: "696b541aea346afc628c05ef80698a77f9b660649b428b67ce0e12904c94f350"
        ),
        .testTarget(
