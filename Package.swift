...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.35-8d08b34e/TDLibFramework.zip",
            checksum: "aaaa0d4b0e30f200675febd831ad161dae6e7fab20531b0c347a544e09d816b9"
        ),
        .testTarget(
