...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.17-edc52845/TDLibFramework.zip",
            checksum: "b2aac176c91aa48d8abe38c4d43b33caddcc89a3ea8d402ceec31af080a56765"
        ),
        .testTarget(
