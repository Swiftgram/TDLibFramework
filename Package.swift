...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.23-94133602/TDLibFramework.zip",
            checksum: "5af066d7c8bfc5dd9cecb0e4c7ca443b81e78f7104b51f22d1f1d6af035e71c5"
        ),
        .testTarget(
