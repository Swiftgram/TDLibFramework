...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.49-e6d0516e/TDLibFramework.zip",
            checksum: "a7e894cf437d6d5f82d6602de19f8722d7be13fe777f2fd126a168863774591e"
        ),
        .testTarget(
