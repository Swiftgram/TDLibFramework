...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.34-81dc2e24/TDLibFramework.zip",
            checksum: "3f90a846a7f169ce4a2172f4c31b8f128603ba8a474d5f11a98f86c0aaaf23d8"
        ),
        .testTarget(
