...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.20-f441415d/TDLibFramework.zip",
            checksum: "f0fc162d136cc968d49ebcc429be9c4afcffdcde66e68138cfd3237fa3357280"
        ),
        .testTarget(
