...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.39-18618cad/TDLibFramework.zip",
            checksum: "0aaeb18b5db76632768bc5ab3b9cc635af71e8f85fcf33975500d37928476e22"
        ),
        .testTarget(
