...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.32-2820a9d2/TDLibFramework.zip",
            checksum: "29518a9e62a355dc7dd41dd8a37c1afd96cd121bc9eefcb0a814548b00c72791"
        ),
        .testTarget(
