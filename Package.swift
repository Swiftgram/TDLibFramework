...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.50-1e75ca0c/TDLibFramework.zip",
            checksum: "68e4de9904b989447dd511c51d223db4328ae1491507ee9ce08ddff85a799ea3"
        ),
        .testTarget(
