...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.52-41c91073/TDLibFramework.zip",
            checksum: "f9b0aa7dc87422cc443566c74d9e204ccb6b0c3dd94289f16aeeb612a4037a88"
        ),
        .testTarget(
