...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.21-9184b3e6/TDLibFramework.zip",
            checksum: "3c32ae06335504426432837efb43d720492eee42523aa725c42b0f5324d1a5cc"
        ),
        .testTarget(
