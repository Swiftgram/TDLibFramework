...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.14-3d4b4ac0/TDLibFramework.zip",
            checksum: "fa5e7d36fd2dd52cc6019f63a2efcc925feb91ee4715fb2cf90ce7fd0169962c"
        ),
        .testTarget(
