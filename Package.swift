...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.51-bb474a20/TDLibFramework.zip",
            checksum: "5ba41939f302b01fc6c2ee65161f9e9e2d68fcc3eb1fb8084269f9b31fed9f81"
        ),
        .testTarget(
