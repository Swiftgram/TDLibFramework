...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.19-b41a51f2/TDLibFramework.zip",
            checksum: "beb794253aee99b4ef8f61d1ec1e9b33bc5368825b6918e23e4f842e1dceb98d"
        ),
        .testTarget(
