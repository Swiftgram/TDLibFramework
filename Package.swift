...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.64-49b3bcbb/TDLibFramework.zip",
            checksum: "ce572346bfd91f7002018ee14dc9e0a627667952eafae036b0a1b122d44e90a1"
        ),
        .testTarget(
