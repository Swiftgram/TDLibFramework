...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.51-da4e46f2/TDLibFramework.zip",
            checksum: "64d6181be146bd0d1c04c9560b397db3a20b3a47f484f94f97f63688fd647b79"
        ),
        .testTarget(
