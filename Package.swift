...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.36-87d88107/TDLibFramework.zip",
            checksum: "12978d2d3dcc9ed67119a2b471a1c297b50db75ec9b877e3777f29a720d34c87"
        ),
        .testTarget(
