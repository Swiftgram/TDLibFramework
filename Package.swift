...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.28-2424d681/TDLibFramework.zip",
            checksum: "2e2715d214020e842004c2f51d1108a11f4967534b1299d3c7ec88ba5987a8d0"
        ),
        .testTarget(
