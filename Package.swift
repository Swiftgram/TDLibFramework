...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.50-64852808/TDLibFramework.zip",
            checksum: "9fad743138b0f162bb9a6d4d8b8ffbc14e4015ed22ee6ecc876d8e01a04d7bcb"
        ),
        .testTarget(
