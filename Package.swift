...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.52-4269f54e/TDLibFramework.zip",
            checksum: "f95e1fbf79c33d24a8be70e1f5f9492d924c22fcafae2cc80f1fd3594524689f"
        ),
        .testTarget(
