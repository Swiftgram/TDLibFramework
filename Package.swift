...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.16-203e8cf9/TDLibFramework.zip",
            checksum: "3a33411343b45d5bc6605bc2b246de4c3af36912feb5f2990dc543f7d750425d"
        ),
        .testTarget(
