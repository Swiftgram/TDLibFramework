...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.41-437e7f9a/TDLibFramework.zip",
            checksum: "a1d26a73b620d93baafac15bf3cf9c5f280dcc94ac85f2638ffa4fd9ff461571"
        ),
        .testTarget(
