...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.15-6a6cd8af/TDLibFramework.zip",
            checksum: "6f8ae4bc34d2ccc49fc04f0da94aa1f569b483a44006e5bee2f44bfdee8be47d"
        ),
        .testTarget(
