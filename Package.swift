...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.33-97ded010/TDLibFramework.zip",
            checksum: "04fec7cb60d7c600bbabf84b04be217f213019b452ad9ca6367de1fa2e2895e7"
        ),
        .testTarget(
