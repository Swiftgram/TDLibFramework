...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.66-d8d46dfa/TDLibFramework.zip",
            checksum: "35e5239ddfdc447266eb03525cc8595d8db304934b309d9cb2c5af3091c5074d"
        ),
        .testTarget(
