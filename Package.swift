...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.50-fb04b8d4/TDLibFramework.zip",
            checksum: "3fbf17cd04d4cde216fcf09309938d5b096bddfc2c988bab44262a5d76db17e6"
        ),
        .testTarget(
