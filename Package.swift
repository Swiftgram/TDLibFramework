...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.15-ff687167/TDLibFramework.zip",
            checksum: "ca86ce4b18d95837af7017c25ffaaf670d26bfb35d24becb7f3820f340a25449"
        ),
        .testTarget(
