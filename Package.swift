...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.37-6dae0a56/TDLibFramework.zip",
            checksum: "a2a93e7c3c9f4eaba70aa99e442f162ae757fc6d332820fae3e2f9228751b162"
        ),
        .testTarget(
