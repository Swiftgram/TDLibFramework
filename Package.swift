...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.23-d963044e/TDLibFramework.zip",
            checksum: "1ce34409ee5330756d4cb5e0991794bd8ae4500b2442d8dd56c6588fb28994e8"
        ),
        .testTarget(
