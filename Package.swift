...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.50-a5215c03/TDLibFramework.zip",
            checksum: "e03aba9d0cc7317283f2ff239455d18eb5cf48f35d84db1649197e42f888daf4"
        ),
        .testTarget(
