...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.64-e0943d06/TDLibFramework.zip",
            checksum: "0929dbd7d79ca301b60612431aa4e811c946110e4f8439e41ae1b7410436b830"
        ),
        .testTarget(
