...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.41-d961806b/TDLibFramework.zip",
            checksum: "e07948f935251c60ef0bfccfca934716ccba382b0aca63f122d010aa31ffbca3"
        ),
        .testTarget(
