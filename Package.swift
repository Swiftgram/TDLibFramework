...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.38-c684471b/TDLibFramework.zip",
            checksum: "5b819316a225fffdd7b74e9dc5817ebf983d586f98ebb414e6c80d6e546b2652"
        ),
        .testTarget(
