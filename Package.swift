...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.65-d6debbb2/TDLibFramework.zip",
            checksum: "fd8d98e557fd09cc967075e5dcf08834969773ac2a4340aa094716aed970ffe2"
        ),
        .testTarget(
