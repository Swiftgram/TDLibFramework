...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.56-4f4df7c6/TDLibFramework.zip",
            checksum: "a5ecf5aa09344b1c4814b9feebae4332d0674503f124a2b5ac434d0bc1853d83"
        ),
        .testTarget(
