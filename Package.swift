...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.62-af0cb1d3/TDLibFramework.zip",
            checksum: "a2c716d7243d57f9f6dc0f64fbb265dd8a4557cbc4548ffadb30c206ae8c3c9c"
        ),
        .testTarget(
