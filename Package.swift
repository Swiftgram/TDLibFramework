...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.30-4257a341/TDLibFramework.zip",
            checksum: "bbff266a54efa5738c3747aaec7878a008f14bb3c5ad890806553e447f767948"
        ),
        .testTarget(
