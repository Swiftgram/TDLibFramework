...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.37-c1fea0f2/TDLibFramework.zip",
            checksum: "dc1041b3598da49e6267cf4d6f587abc9d723005717ec2b144c36a2caa893e49"
        ),
        .testTarget(
