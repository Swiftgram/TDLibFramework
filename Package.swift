...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.25-d0ff90bb/TDLibFramework.zip",
            checksum: "11a1a1cc3386e965078c8330098214d12aec1712c43db9d95a6da26e0f84dc7e"
        ),
        .testTarget(
