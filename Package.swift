...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.29-e4796b9b/TDLibFramework.zip",
            checksum: "1ad5c3e44ae68d2cfb74294273b420fd4a44b564e5264037365c05df15eff7bd"
        ),
        .testTarget(
