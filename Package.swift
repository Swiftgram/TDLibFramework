...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.19-986f1ab4/TDLibFramework.zip",
            checksum: "fc39e3e4d4fa36b49bb1687aa0d5e984e28f2c078ef8f5005e7fecd9ca0f6404"
        ),
        .testTarget(
