...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.26-b1b33cf4/TDLibFramework.zip",
            checksum: "5649b33ea112538c4ce6d228d8f6d36b4d7442d80593fae89d26fd0b3bd88b58"
        ),
        .testTarget(
