...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.66-ca58a8b2/TDLibFramework.zip",
            checksum: "163352a547d2566e625be39b4fe5a3b158e4e690be84f7af4419f293c89cb21a"
        ),
        .testTarget(
