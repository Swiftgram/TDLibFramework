...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.29-12c1689b/TDLibFramework.zip",
            checksum: "279ecf5d40e9fe443d145c7de842082d55e6cc4203c96df06d772a1c4ff35f3d"
        ),
        .testTarget(
