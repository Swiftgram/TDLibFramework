...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.45-521aed8e/TDLibFramework.zip",
            checksum: "a6894602bb45fed442a383baa553de1deb63d3a0bce60e6f4f28559e5fc0fee3"
        ),
        .testTarget(
