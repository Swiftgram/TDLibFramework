...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.24-c5c55092/TDLibFramework.zip",
            checksum: "4ef9f10696726d7fd04ad81733a90f08878d5a03c2b5404dcef8b482c9e762a4"
        ),
        .testTarget(
