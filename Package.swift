...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.22-3f00bebf/TDLibFramework.zip",
            checksum: "84074310b2e76a9338d1ce5b191d774169f97c50f212341699a27209a83a1824"
        ),
        .testTarget(
