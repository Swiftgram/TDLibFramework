...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.30-b102c3ad/TDLibFramework.zip",
            checksum: "f30040bd9f28cb58ee6988209f8f7396370c6fbb4d6e783ae2a8a522014df4d7"
        ),
        .testTarget(
