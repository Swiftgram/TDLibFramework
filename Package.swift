...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.24-437c2d0c/TDLibFramework.zip",
            checksum: "96d44662a63cba42fe064691cbb84d72255b124b92f600d4e468958edb948509"
        ),
        .testTarget(
