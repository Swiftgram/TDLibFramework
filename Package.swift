...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.46-207f3be7/TDLibFramework.zip",
            checksum: "6f1efd837eb20b95af80b756b8526381c423ecf2782cad2e1c9bcae5fde3c818"
        ),
        .testTarget(
