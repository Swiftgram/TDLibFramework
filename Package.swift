...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.31-63c7d030/TDLibFramework.zip",
            checksum: "feea94857e4aafd0cc7755e70908bce3fb95ebaf24a630d662d087a0eca48c9b"
        ),
        .testTarget(
