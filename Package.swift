...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.63-8fc2344f/TDLibFramework.zip",
            checksum: "023e50a63e416c44a721af8e6d9d33c29dc08971a5c4abbfb6ba5ab9178849e8"
        ),
        .testTarget(
