...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.67-d1085f9c/TDLibFramework.zip",
            checksum: "bed17bcd44bbd35d13cd26473418afc9abdadacc11b6b7d30e9d191347339ddc"
        ),
        .testTarget(
