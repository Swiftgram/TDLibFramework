...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.52-5c77c469/TDLibFramework.zip",
            checksum: "b25c1c153428598e3b54356f10505d724d1abf3e8267fc3bf208d3fe61258879"
        ),
        .testTarget(
