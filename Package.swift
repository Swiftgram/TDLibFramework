...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.40-22d49d5b/TDLibFramework.zip",
            checksum: "d5d0a9a8ea2137916be5abfe26c3a9883bd80cb94ee9f1f0e5e198aa5ebc256b"
        ),
        .testTarget(
