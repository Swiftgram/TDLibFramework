...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.20-522d5448/TDLibFramework.zip",
            checksum: "06d5474c2aff0889cebee6dece3f8114073d2a4ca5a932ecc80fc8fece0df614"
        ),
        .testTarget(
