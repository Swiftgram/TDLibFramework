...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.62-0ae923c4/TDLibFramework.zip",
            checksum: "57494c0f2a44aefd0aa7fd336e2c2321106a7836e3d4a982ef222ae3f9271664"
        ),
        .testTarget(
