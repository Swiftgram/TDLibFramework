...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.65-a17f87c4/TDLibFramework.zip",
            checksum: "fd7dfa244a152d472d4519471afdd1487ef8493a94f016c0a83c2e5d5419ac00"
        ),
        .testTarget(
