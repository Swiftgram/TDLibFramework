...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.67-738ae316/TDLibFramework.zip",
            checksum: "568502bfd2821974ed9bbb604ab835d6b2499bd39350ecc2959ea5179447ddbb"
        ),
        .testTarget(
