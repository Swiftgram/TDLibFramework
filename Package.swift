...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.34-a24af099/TDLibFramework.zip",
            checksum: "5450d8fc9fe283bc541ca17868f28f145e3aabeb4e6b1dbb32e94c60dd3522b2"
        ),
        .testTarget(
