...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.51-5d1fe744/TDLibFramework.zip",
            checksum: "2a0cca7d926bf75abe5a129501565bbd3b6ed077cae8535416b045ea6a15486a"
        ),
        .testTarget(
