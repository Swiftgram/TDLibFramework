...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.27-d7203eb7/TDLibFramework.zip",
            checksum: "be6f566635d1d52a342f23e3ec1e79865cdacc4d197ad5bf87036599f21e0c4d"
        ),
        .testTarget(
