...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.21-21d5184e/TDLibFramework.zip",
            checksum: "0b57fbb8ee1b52cb9d66ac37f128a48e63e80128f53804ecee003f5447b3c9ff"
        ),
        .testTarget(
