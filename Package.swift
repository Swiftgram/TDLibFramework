...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.14-66234ae2/TDLibFramework.zip",
            checksum: "1bd234679d7eb5cdace37bfcbf42e517e4b38c523d9c29e3c41ddf8eae701546"
        ),
        .testTarget(
