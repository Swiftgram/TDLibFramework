...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.29-783033c4/TDLibFramework.zip",
            checksum: "7bef6fae462fe8a671180eda5e3ffbc82883c9fc2561c07bbba42b90061d8fa4"
        ),
        .testTarget(
