...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.28-4d90c2a2/TDLibFramework.zip",
            checksum: "2d0af41c44bfe35766d3b64e1627d9cba975ba7230ca71aafe43da4ca6e7ede0"
        ),
        .testTarget(
