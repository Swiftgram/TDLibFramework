...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.25-6c5441c8/TDLibFramework.zip",
            checksum: "c24db775364bd8ba15a6e0127226d3b55c01cc317386cbab04ac61a20ee9c9e1"
        ),
        .testTarget(
