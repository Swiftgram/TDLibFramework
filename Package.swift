...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.61-6d509061/TDLibFramework.zip",
            checksum: "51cb6f04e0a93b2cb7fbbe922f6a231a9c019a74706ccf9f84db89ccac641be5"
        ),
        .testTarget(
