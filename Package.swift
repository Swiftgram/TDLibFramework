...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.21-07c1d53a/TDLibFramework.zip",
            checksum: "24a9e49c87e2b6716c226afefe100ae9c81406a34f8c7a7ffc8c21b383ac5565"
        ),
        .testTarget(
