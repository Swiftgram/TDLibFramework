...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.51-6c8bfbb5/TDLibFramework.zip",
            checksum: "3d79ddfa1a8c9b3b95b58cc8c293a6d688ca517ad9885f99069f37584f4578f5"
        ),
        .testTarget(
