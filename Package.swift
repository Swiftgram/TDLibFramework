...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.52-bc32c4b2/TDLibFramework.zip",
            checksum: "43cf5a50351da7df29b6eddd9b446819918411341816ca61a1aaec33a293cd52"
        ),
        .testTarget(
