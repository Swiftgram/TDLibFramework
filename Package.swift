...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.22-8951949e/TDLibFramework.zip",
            checksum: "846366be34f6eb682d52518cf869b1e3ca5aaf40a53e49b20f1e5646870c31d1"
        ),
        .testTarget(
