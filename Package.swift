...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.32-35cfcf5d/TDLibFramework.zip",
            checksum: "f56c9b572aabf7f7624ee22fa39f664b0b1ebd85c9c502ce4b10d066c9b1ada9"
        ),
        .testTarget(
