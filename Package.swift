...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.32-3cd93569/TDLibFramework.zip",
            checksum: "0ca888d3d43f0bae5067864df4ebd5ecdd40ad80e3f52a1b546da497ceb00412"
        ),
        .testTarget(
