...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.21-da9afda7/TDLibFramework.zip",
            checksum: "d04bfa4c314379d8b04e882066610fad87d915794297dfb4cd12603cbf8721ea"
        ),
        .testTarget(
