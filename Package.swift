...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.19-9b4266c0/TDLibFramework.zip",
            checksum: "0b956fe3e639fb7ed21871f9d1b17f2ccf6662831dd38b8bd66c58865f4aa01b"
        ),
        .testTarget(
