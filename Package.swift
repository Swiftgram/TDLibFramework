...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.31-8f19c751/TDLibFramework.zip",
            checksum: "eb3e2d46424a923ef0aaba039bfc01f5ba4d6282ef03cdcbd4efd010125dd5c6"
        ),
        .testTarget(
