...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.47-04adfc87/TDLibFramework.zip",
            checksum: "b68703c580f73a6c69ce2cb5a34a6d16ed66718545ab4751115227d39182162f"
        ),
        .testTarget(
