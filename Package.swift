...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.37-fe6f2f93/TDLibFramework.zip",
            checksum: "7f3dbeec3ae5a23a68b01086febe53ebf23a3fbb16c3cad94307c4922e4bc2bf"
        ),
        .testTarget(
