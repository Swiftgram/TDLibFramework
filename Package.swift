...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.23-5bbfc1cf/TDLibFramework.zip",
            checksum: "f7b3832934b1d1c0e25e96e05f23cb1cf351646302ca836fd68e39b87cdc4951"
        ),
        .testTarget(
