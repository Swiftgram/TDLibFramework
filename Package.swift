...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.15-2e5319ff/TDLibFramework.zip",
            checksum: "2fd5bbde095404ec45538e6cbc0a3fb6d840f236a0a9fece6e77fad4b76e1dd5"
        ),
        .testTarget(
