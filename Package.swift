...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.66-1b08c83b/TDLibFramework.zip",
            checksum: "8a86289d1e883a5e204f08bd58beb4b8e2f29f686d090c1ebb3cab38d078b788"
        ),
        .testTarget(
