...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.15-53888437/TDLibFramework.zip",
            checksum: "16a5a3c96d18604d488a3f1336e66844a6554b1ed3c2b7272ffe6802d105d1da"
        ),
        .testTarget(
