...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.41-c85b20a4/TDLibFramework.zip",
            checksum: "cc332e61891faf8a4e4af20cca18a2296642e728a701ebdcff54bffc078c5e5d"
        ),
        .testTarget(
