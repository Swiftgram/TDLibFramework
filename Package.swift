...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.66-a6938361/TDLibFramework.zip",
            checksum: "a4c08966f74cf8695b639e5ae1a66218053281998297ebbf7ee0f2bc4d7a59ec"
        ),
        .testTarget(
