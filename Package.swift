...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.65-062f2605/TDLibFramework.zip",
            checksum: "814174bbaeb5dba4df61ec973333cd4e82ac7acdcb4d5a0adfe90c52db271f5b"
        ),
        .testTarget(
