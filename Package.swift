...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.18-daf48013/TDLibFramework.zip",
            checksum: "39c5736edd17a9bc944ab5a8ef3105c08e1f5a916f606f85d0fa4fb055dd0767"
        ),
        .testTarget(
