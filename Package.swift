...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.15-8893dc80/TDLibFramework.zip",
            checksum: "8bcea77143cba0dcef08df780e6c16c2c9f1ce54c2e5fb828d1e64ac8ace37fb"
        ),
        .testTarget(
