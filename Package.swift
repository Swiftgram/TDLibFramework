...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.50-e133ac6d/TDLibFramework.zip",
            checksum: "6c6820c612c93768b81bb9e32ac51fbd4aa10dea167ef5cfa9dcfe8f565caf44"
        ),
        .testTarget(
