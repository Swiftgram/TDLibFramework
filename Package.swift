...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.26-b41f3219/TDLibFramework.zip",
            checksum: "9315379ccdb0af1615ae0d5084befe794e89c95f3624892d9819ebb4ed3339e6"
        ),
        .testTarget(
