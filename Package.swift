...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.17-00258ccb/TDLibFramework.zip",
            checksum: "3f9a0648f4212208969a32680cdc3aa66f74b5e8978312ed74617b8a63041ff6"
        ),
        .testTarget(
