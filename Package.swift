...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.47-6e32e56b/TDLibFramework.zip",
            checksum: "e81032db3841eca7f1cf7edf90b9d484167976c30be36f615f53e8d51dd7e0f2"
        ),
        .testTarget(
