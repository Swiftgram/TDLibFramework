...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.24-d79bd4b6/TDLibFramework.zip",
            checksum: "23a88115874708d9102b21a3c1248a77fcd414ae764d74be740778557ad9b463"
        ),
        .testTarget(
